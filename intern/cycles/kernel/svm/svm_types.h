...
typedef enum ClosureType {
	...
	CLOSURE_BSDF_METALLIC_ARTISTIC_ID,
	CLOSURE_BSDF_METALLIC_PHYSICAL_ID,
	CLOSURE_BSDF_METALLIC_ANISO_ARTISTIC_ID,
...
#define CLOSURE_IS_BSDF_ANISOTROPIC(type) (type >= CLOSURE_BSDF_METALLIC_ANISO_ARTISTIC_ID && type <= CLOSURE_BSDF_ASHIKHMIN_SHIRLEY_ANISO_ID)
